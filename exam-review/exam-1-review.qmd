...
Which of the following is [**correct**]{.underline}? Choose all that apply.
...
**Question 9:** A friend with a keen eye points out that the number of observations in @fig-salary-performance-rating-1 seems lower than the total number of observations in `blizzard_salary`. What might be going on here? Explain your reasoning.
...
**Question 10:** Below are the proportions of performance ratings for hourly and salaried workers. Place these values in the corresponding segments in @fig-salary-performance-rating-2.
