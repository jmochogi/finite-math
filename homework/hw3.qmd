...
b.  Use the idea of indicator values to determine whether a cheaper plan than the one you found in (a) above exists. Be sure to show all work. <br> <br><br> \newpage
c.  Use the stepping-stone method to find the optimal shipment plan (i.e., the cheapest plan). What is the cost of this plan? Show all steps and explain how you know that you have found the cheapest plan. \newpage

## Problem 2

A company supplies water from its three water purification plants (P1, P2, and P3) to four different companies (C1, C2, C3, and C4) that resell the water to office buildings. The transportation costs (in thousands of dollars) from each plant to each company are given in the following table:

![](/img/c1.png){fig-align="center" width="300"}

Additionally, each supplier has a supply limit, and each consumer has a demand requirement as listed below:
...
b.  Determine how many units should be transported from each supplier to consumers while minimizing the total transportation cost. What would be the minimum transportation cost? Be sure to show/explain your work.
...
d.  Is the game fair? How do you know? <br> <br>
